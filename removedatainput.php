   ...
   <body class="text-center">
      <div class="cover-container d-flex h-100 p-2 mx-auto flex-column">
         ...
         <main role="main" class="innercover">
            <h1 class="cover-heading">Remove Data</h1>
            <br>
            <form id="formcontainer" action="removedata.php" method="POST">
               <div class="form-group row">
                  <label for="inputID" class="col-sm-2 col-form-label">Data ID:</label>
                  <div class="col-sm-10">
