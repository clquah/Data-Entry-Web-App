...
EOF;
            ...
            <?php } ?>
            <?php if(!$valid){ ?>
            <h1 class="cover-heading">Input invalid or Passwords doesnt match! Please try again</h1>
            <?php }?>
            <div>
               <br>
               <a class="btn btn-primary" href="changepasswordinput.php" role="button">Back</a>
            </div>
         </main>
